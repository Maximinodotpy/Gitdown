<fieldset>
    ...
    <label for="resolver_simple">
        <input type="radio" name="<?php echo MGD_SETTING_RESOLVER ?>"  id="resolver_simple" value="simple" <?php echo get_option(MGD_SETTING_RESOLVER) == 'simple' ? 'checked' : '' ?>>
        <span>Simple</span>
    ...
    <label for="resolver_directory_category">
        <input type="radio" name="<?php echo MGD_SETTING_RESOLVER ?>" 
            id="resolver_directory_category" value="dir_cat" <?php echo get_option(MGD_SETTING_RESOLVER) == 'dir_cat' ? 'checked' : '' ?>>
    ...
    <!-- <label for="resolver_custom">
        <input type="radio" name="<?php echo MGD_SETTING_RESOLVER ?>"  id="resolver_custom" value="custom" <?php echo get_option(MGD_SETTING_RESOLVER) == 'simple' ? 'checked' : '' ?>>
        <span>Custom</span>
